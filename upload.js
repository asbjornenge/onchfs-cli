...
//    const oversizedFile = files.find(file => fs.statSync(file).size > CONFIG.network.BATCH_SIZE_LIMIT)
//    if (oversizedFile) {
//      console.error(`Error: File ${oversizedFile} exceeds the limit of ${CONFIG.network.BATCH_SIZE_LIMIT} bytes.`);
//      process.exit(1);
//    }
//
